...
export function useBranding() {
  ...
  /**
   * Replaces "QualiChat" in text with the installation name from global config
   * @param {string} text - The text to process
   * @returns {string} - Text with "QualiChat" replaced by installation name
   */
  const replaceInstallationName = text => {
    ...
    return text.replace(/QualiChat/g, installationName);
  };
