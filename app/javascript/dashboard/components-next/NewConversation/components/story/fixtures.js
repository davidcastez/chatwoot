export const contacts = [
  {
    ...
    email: 'ozler@qualichat.vercel.app',
    id: 29,
    name: 'Abraham Ozlers',
    ...
    customAttributes: {
      ...
      linkContact: 'https://staging.qualichat.vercel.app/app/accounts/3/contacts-new',
...
export const activeContact = {
  email: 'ozler@qualichat.vercel.app',
  id: 29,
  label: 'Abraham Ozlers (ozler@qualichat.vercel.app)',
  name: 'Abraham Ozlers',
  thumbnail: {
    name: 'Abraham Ozlers',
