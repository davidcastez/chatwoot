...
const conversationWithoutMeta = {
  meta: {
    sender: {
      ...
      email: 'candice@qualichat.vercel.app',
      id: 29,
    ...
    assignee: {
      ...
      autoOffline: false,
      confirmed: true,
      email: 'sivin@qualichat.vercel.app',
      availableName: 'Sivin',
      name: 'Sivin',
      role: 'administrator',
      thumbnail: '',
  ...
  messages: [
    {
      ...
      conversation: {
        ...
        contactInbox: {
          sourceId: 'candice@qualichat.vercel.app',
        },
      },
    },
  ],
  ...
  lastNonActivityMessage: {
    ...
    conversation: {
      ...
      contact_inbox: {
        source_id: 'candice@qualichat.vercel.app',
      },
    },
    sender: {
      id: 1,
...
const conversationWithMeta = {
  meta: {
    sender: {
      additionalAttributes: {},
      availabilityStatus: 'offline',
      email: 'willy@qualichat.vercel.app',
      id: 29,
      name: 'Willy Castelot',
  ...
  lastNonActivityMessage: {
    ...
    conversation: {
      ...
      last_activity_at: 1730885428,
      contact_inbox: {
        source_id: 'willy@qualichat.vercel.app',
      },
    },
    sender: {
      id: 1,
