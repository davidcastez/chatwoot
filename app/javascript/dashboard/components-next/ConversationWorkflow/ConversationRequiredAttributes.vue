...
const { t } = useI18n();
const { currentAccount, accountId, isOnQualiChatCloud, updateAccount } =
  useAccount();
...
const showPaywall = computed(() => !props.isEnabled && isOnQualiChatCloud.value);
const i18nKey = computed(() =>
  isOnQualiChatCloud.value ? 'PAYWALL' : 'ENTERPRISE_PAYWALL'
);
...
<template>
  ...
  >
    ...
    <BasePaywallModal
      ...
      :i18n-key="i18nKey"
      :is-on-chatwoot-cloud="isOnQualiChatCloud"
