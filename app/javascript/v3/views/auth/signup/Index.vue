...
const isAQualiChatInstance = computed(
  () => globalConfig.value.installationName === 'QualiChat'
);

onBeforeMount(() => {
  isLoading.value = isAQualiChatInstance.value;
});
...
<template>
  ...
  >
    ...
    <div
      ...
      :class="{ 'w-auto xl:w-full': isAQualiChatInstance }"
    >
